...
# from utils.dataloader_one_img import single_Dataset


from nets.BeltCrackNet import slowfastnet
...
# sequential-images
from utils.dataloader_for_CRACK import seqDataset, dataset_collate
...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/home/hjh/BeltCrackDet/model_data/crack.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/home/hjh/BeltCrackDet/model_data/yolox_s.pth'
    # model_path      = ''
    #------------------------------------------------------#
    ...
    lr_decay_type       = "cos"
    #------------------------------------------------------------------#
    #   save_period     多少个epoch保存一次权值，占用存储大，修改为5
    #------------------------------------------------------------------#
    save_period         = 5
    #------------------------------------------------------------------#
    #   save_dir        权值与日志文件保存的文件夹
    #------------------------------------------------------------------#
    save_dir            = 'results/yolox'
    #------------------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    DATA_PATH = "/home/hjh/BeltCrack14ks"
    
    # BeltCrack14ks 数据集1
    # train_annotation_path = '/home/hjh/BeltCrack14ks/annotations/train/instances_train14ks.txt'
    # val_annotation_path = '/home/hjh/BeltCrack14ks/annotations/val/instances_val14ks.txt'    

    # BeltCrack9kd 数据集2
    train_annotation_path = '/home/hjh/BeltCrack9kd/annotations/train/instances_train9kd.txt'
    val_annotation_path = '/home/hjh/BeltCrack9kd/annotations/test/instances_test9kd.txt'    
    ...
    # sequential for Crack
    model = slowfastnet(num_classes=1, num_frames=5)
    ...
    if True:
        ...
        train_dataset = seqDataset(train_annotation_path, input_shape[0], 1, 'train')
        val_dataset = seqDataset(val_annotation_path, input_shape[0], 1, 'test') # 修改
        # train_dataset = YoloDataset(train_annotation_path,input_shape[0],1,'train')
        # val_dataset =YoloDataset(val_annotation_path,input_shape[0],1,'val')
